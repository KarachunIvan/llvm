...
typedef cl::sycl::cl_##type __##type##_t;      \
typedef cl::sycl::cl_##type __##type##2_vec_t  \
  __attribute__((ext_vector_type(2)));         \
typedef cl::sycl::cl_##type __##type##3_vec_t  \
  __attribute__((ext_vector_type(3)));         \
typedef cl::sycl::cl_##type __##type##4_vec_t  \
  __attribute__((ext_vector_type(4)));         \
typedef cl::sycl::cl_##type __##type##8_vec_t  \
  __attribute__((ext_vector_type(8)));         \
typedef cl::sycl::cl_##type __##type##16_vec_t \
  __attribute__((ext_vector_type(16)));

#define DECLARE_LLTYPE_T(type)                 \
typedef cl::sycl::type __##type##_t;           \
typedef cl::sycl::type __##type##2_vec_t       \
  __attribute__((ext_vector_type(2)));         \
typedef cl::sycl::type __##type##3_vec_t       \
  __attribute__((ext_vector_type(3)));         \
typedef cl::sycl::type __##type##4_vec_t       \
  __attribute__((ext_vector_type(4)));         \
typedef cl::sycl::type __##type##8_vec_t       \
  __attribute__((ext_vector_type(8)));         \
typedef cl::sycl::type __##type##16_vec_t      \
  __attribute__((ext_vector_type(16)));
...
#define DECLARE_FLOAT_CONVERTER(base, num)                                     \
  ...
  public:                                                                      \
    using DataType = detail::select_apply_cl_t<base, std::false_type,          \
      GET_CL_TYPE(half, num), GET_CL_TYPE(float, num),                         \
